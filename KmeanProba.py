# -*- coding: utf-8 -*-
"""
Created on Mon Apr 11 19:21:35 2022
    ...
    def init_centroids(self,data):
      ...
      #centroids=pd.DataFrame(data.iloc[418]).T
        for cent in range(self.k-1):
            ...
            centroids=centroids.append(data.iloc[index_max_dist])
        return centroids
          ...
          #          dist=self.calc_distance(self.distance,slucaj,centroids)
           #         clusters[i]=np.argmin(dist)
                ...
                for centroid in range(self.k):
                    ...
                    quality[centroid]=(data[clusters==centroid].var()*weights).sum()*len(data[clusters==centroid])
